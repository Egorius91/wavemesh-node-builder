...
def prepare(a):
    ...
    cfg.setdefault("exits",[]).append({"id":exit_id,"display_name":a.display_name or e["display_name"],"country":e["country"],"city":e["city"],"enabled":True,"manifest_checksum":manifest["checksum_sha256"],"endpoint":{"domain":e["domain"],"port":e["port"],"security":"tls","sni":e["sni"],"host":e["host"],"fingerprint":e["fingerprint"],"transport":"xhttp","xhttp_mode":"stream-one","relay_path":e["relay_path"],"relay_uuid":e["relay_uuid"]},"xray":{"outbound_tag":outbound_tag}})
