...
wm_native_capabilities_json() {
  cat <<'JSON'
{"clients_api":true,"settings_api":true,"inbounds_api":true,"native_listener_loopback":true,"sub_enable":true,"sub_listen":"127.0.0.1","sub_port":2096,"local_port_matches":true,"sub_path_matches":true,"remark_template_matches":true,"custom_renderer_locations":true,"ready":false}
JSON
}
